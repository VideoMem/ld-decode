...
public:
    ...
    //
    // outputFrames should contain RGB48 or YUV444p output frames, with the first
    // frame being startFrameNumber.
    //
    // Returns true on success, false on failure.
    bool putOutputFrames(qint32 startFrameNumber, const QVector<videoFrame> &outputFrames);

private:
    bool putOutputFrame(qint32 frameNumber, const videoFrame &outputFrame);
    ...
    QMap<qint32, videoFrame> pendingOutputFrames;
    QFile targetVideo;
